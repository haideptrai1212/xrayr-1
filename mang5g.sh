...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://data.mang5g.me"
      ApiKey: "adminmang5g.me@gmail.com"
      NodeID: $NodeID80
      NodeType: V2ray 
      Timeout: 30 
      EnableVless: false 
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/ssl-mang5g/crt.crt
        KeyFile: /etc/XrayR/ssl-mang5g/key.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
...
EOF
	cd /etc/XrayR
	git clone https://github.com/fast4gvpn/ssl-mang5g.git
	XrayR restart
